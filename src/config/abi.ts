export const FENIX_ABI = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint40", name: "startTs", type: "uint40" },
          { internalType: "uint40", name: "deferralTs", type: "uint40" },
          { internalType: "uint40", name: "endTs", type: "uint40" },
          { internalType: "uint16", name: "term", type: "uint16" },
          { internalType: "uint256", name: "fenix", type: "uint256" },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint40", name: "rewardTs", type: "uint40" },
          { internalType: "uint256", name: "fenix", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "xen", type: "uint256" }],
    name: "burnXEN",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint256", name: "fenix", type: "uint256" }],
